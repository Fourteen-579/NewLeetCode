...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().countValidWords(s));
    }

    public boolean have1(char c) {
        if (c == '!' || c == '.' || c == ',') {
            return true;
        } else {
            return false;
    ...
    public int countValidWords(String sentence) {
        ...
        for (String s : split) {
            ...
            for (int i = 0; i < s.length(); i++) {
                ...
                if (have1(s.charAt(i)) && i != s.length() - 1) {
                    flag2 = false;
                    continue;
                }
                if (have2(s.charAt(i))) {
