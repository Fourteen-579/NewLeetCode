...
//        streamTest.testForJoinStrings();
    ...
    public void flatMapTest() {
        //将句子中的单词分割出来返回数组
        List<String> sentences = Arrays.asList("hello world", "This is a sentence");
    ...
    public void peekAndMapTest() {
        ...
        List<Object> collect1 = Stream.of(1, 2, 3)
                .map(e -> {
                    e = e + 1;
                    return e;
                }).collect(Collectors.toList());
    ...
    public void testForJoinStrings() {
        ...
        System.out.println("String.join:" + String.join(",", ids));
        ...
        String collect1 = users.stream()
                .map(User::getId)
                .collect(Collectors.joining(","));
        System.out.println("stream2:" + collect1);
    }
...
class Adder implements Callable<Integer> {
    ...
    Adder(int from, int to, ExecutorService executor) {
        this.from = from;
        this.to = to;
    ...
    public Integer call() throws Exception {
        ...
        Adder adder1 = new Adder(from, center, executor);
        Adder adder2 = new Adder(center + 1, to, executor);
        Future<Integer> submit1 = executor.submit(adder1);
        Future<Integer> submit2 = executor.submit(adder2);
